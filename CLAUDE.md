...
- **D20 — BR-4 กับการปิดงานใน Phase 2:** ✅ เฟส 2 ปิดงานได้ทุกใบโดย**ยังไม่ตรวจ** `receiptConfirmed`
  ตาม §9 ที่จัด BR-4 ไว้ใน Phase 3 พร้อมเรื่องรูป · Phase 3 ต้องเพิ่มปุ่ม "ยืนยันรับของแล้ว" + guard
  แล้วกลับไปแก้เทสต์ `ใบงานที่มีรับเอกสารยังปิดได้ในเฟสนี้` ที่ตรึงพฤติกรรมปัจจุบันไว้
